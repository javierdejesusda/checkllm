...
class JudgeChecksMixin:
    ...
    def context_relevance(
        ...
        return self._cached_judge_check(
            ...
            cache_kwargs={"output": context, "query": query, "threshold": str(t)},
            runs=runs,
            threshold=t,
    ...
    def consistency(
        ...
        return self._cached_judge_check(
            ...
            cache_kwargs={"output": "|".join(outputs), "threshold": str(t)},
            runs=runs,
            threshold=t,
    ...
    def knowledge_retention(
        ...
        return self._cached_judge_check(
            ...
            cache_kwargs={"output": transcript, "threshold": str(t)},
            runs=runs,
            threshold=t,
    ...
    def plan_quality(
        ...
        return self._cached_judge_check(
            ...
            cache_kwargs={"output": plan, "task": task, "threshold": str(t)},
            runs=runs,
            threshold=t,
            input_preview=plan,
        )
    ...
    def step_efficiency(
        ...
        return self._cached_judge_check(
            ...
            cache_kwargs={"output": "|".join(steps), "task": task, "threshold": str(t)},
            runs=runs,
            threshold=t,
    ...
    def plan_adherence(
        ...
        return self._cached_judge_check(
            ...
            cache_kwargs={"output": execution_trace, "plan": plan, "threshold": str(t)},
            runs=runs,
            threshold=t,
            input_preview=plan,
        )
